...
public class DrawerExampleActivity extends Activity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!mNavigationDrawerFragment.isDrawerOpen()) {
            ...
            getMenuInflater().inflate(R.menu.drawer_example, menu);
            restoreActionBar();
            return true;
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_drawer_example, container, false);
            return rootView;
        }
        ...
        public void onAttach(Activity activity) {
            ...
            ((DrawerExampleActivity) activity).onSectionAttached(
